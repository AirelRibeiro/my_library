      ...
      <div className="relative z-20 flex items-center overflow-hidden bg-slate-200  dark:bg-gray-800">
        <div className="container relative flex px-6 py-16 mx-auto">
          <div className="relative z-20 flex flex-col sm:w-2/3 lg:w-1/2 lg:pl-10 ">
            <h1 className="flex flex-col text-2xl font-black leading-none text-bl font-adm md:text-5xl dark:text-white animate-bounce">
              Library Construction Experts
            </h1>
            <p className="text-sm text-gray-700 sm:text-base dark:text-white pt-8">
            ...
            <div className="flex mt-8">
              ...
              <a
                href="#"
                className="px-2 sm:px-4 py-1 sm:py-2 text-blue-900  bg-transparent border-2 border-blue-900 rounded-lg dark:text-white hover:bg-blue-900 hover:text-white text-xs sm:text-lg"
              >
                Solicitar orçamento
              </a>
            </div>
